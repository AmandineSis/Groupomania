<template>
    <form class="form" >
        ...
        <div class="form__valid">
            ...
            <button type= "submit" @click="signupValidation" >S'inscrire</button>
        </div>
    </form> 
</template>
    ...
    methods: {     
        ...
        signupValidation(){
            if ( !this.firstNameValid && !this.lastNameValid && !this.emailValid && !this.passwordValid) {
                return alert("Les informations saisies ne sont pas valides");
            }else{
                this.addNewUser()
                }
            },
        ...
        addNewUser(){
                ...
                axios
                    ...
                    .catch(function (err){
                        console.log("erreur : " + err)});
                        return this.error.emailExists = true; 
            }        
    }
})
</script>
